...
import { FileText, Printer, Eye, BookOpen, AlertCircle, CheckCircle2, Settings, Calendar, Type, Edit, RefreshCw, X, Save, Image as ImageIcon, Upload, Trash2, Plus, Minus, Move, GripHorizontal } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row overflow-hidden print:overflow-visible bg-slate-100">
      ...
      <style>{`
        ...
        /* We rely on index.html for main print styles now to avoid conflicts */
        .watermark {
          position: absolute;
          top: 50%;
          left: 50%;
