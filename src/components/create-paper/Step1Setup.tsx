     ...
     {config.mode === 'past_year' && (
      <div className="mt-8 pt-8 border-t border-slate-100 animate-in fade-in slide-in-from-top-2">
       ...
       <select
        ...
        className="w-full md:w-1/2 px-6 py-4 bg-slate-50 border border-slate-200 rounded-[1.5rem] font-bold text-slate-700 outline-none focus:border-indigo-500"
       >
        <option value="2023">2023 Board Exam</option>
        <option value="2024">2024 Board Exam</option>
        <option value="2022">2022 Board Exam</option>
       </select>
      </div>
     )}
    </div>
